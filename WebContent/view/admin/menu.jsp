    ...
    <TD vAlign=top align=middle>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width=150 border=0>
        ...
        <TR height=22>
          <TD style="PADDING-LEFT: 30px" background=images/menu_bt.jpg><A 
            ...
            href="javascript:void(0);">WebAPP管理</A></TD></TR>
        <TR height=4>
          <TD></TD></TR></TABLE>
      ...
      width=150 border=0>
          ...
          <TD><A class=menuChild 
            href="../editWebApp.do?appid=app1" 
            target="main">投资日报</A></TD></TR>
        <TR height=20>
          <TD align=middle width=30><IMG height=9 
            src="images/menu_icon.gif" width=9></TD>
          <TD><A class=menuChild 
            href="../editWebApp.do?appid=app2" 
            target="main">操作建议</A></TD></TR>
        <TR height=20>
          <TD align=middle width=30><IMG height=9 
            src="images/menu_icon.gif" width=9></TD>
          <TD><A class=menuChild 
            href="../editWebApp.do?appid=app3" 
            target=main>经典战绩</A></TD></TR>
        <TR height=20>
          <TD align=middle width=30><IMG height=9 
            src="images/menu_icon.gif" width=9></TD>
          <TD><A class=menuChild 
            href="../editWebApp.do?appid=app4" 
            target=main>收盘点评</A></TD></TR>
        <TR height=20>
          <TD align=middle width=30><IMG height=9 
            src="images/menu_icon.gif" width=9></TD>
          <TD><A class=menuChild 
            href="../editWebApp.do?appid=app5" 
            target=main>盘中提示</A></TD></TR>
        <TR height=20>
          <TD align=middle width=30><IMG height=9 
            src="images/menu_icon.gif" width=9></TD>
          <TD><A class=menuChild 
            href="../editWebApp.do?appid=app6" 
      ...
      width=150 border=0>
        ...
        <TR height=20>
          <TD align=middle width=30><IMG height=9 
            src="images/menu_icon.gif" width=9></TD>
          <TD><A class=menuChild 
            href="techer_group.do" 
            target=main>分组管理</A></TD></TR>
        <TR height=20>
          <TD align=middle width=30><IMG height=9 
            src="images/menu_icon.gif" width=9></TD>
          <TD><A class=menuChild 
            href="techer_list.do" 
            target=main>老师管理</A></TD></TR>
        <TR height=20>
          <TD align=middle width=30><IMG height=9 
            src="images/menu_icon.gif" width=9></TD>
          <TD><A class=menuChild 
            href="user_list.do" 
            target=main>客户管理</A></TD></TR>
      </TABLE>
      <TABLE cellSpacing=0 cellPadding=0 width=150 border=0>
